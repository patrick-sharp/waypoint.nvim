...
M.global_keybindings_description = {
  ...
  -- {"insert_waypoint"          ,  "Create a waypoint on the current line and add it to the waypoint list before the current waypoint"}          ,
...
M.waypoint_window_keybindings_description = {
  ...
  {"delete_waypoint"           , "Delete the current waypoint(s) from the waypoint list"}              ,
  {"move_waypoint_down"        , "Move the current waypoint(s) before the previous waypoint"}          ,
  {"move_waypoint_up"          , "Move the current waypoint(s) after the next waypoint"}               ,
  {"move_waypoint_to_top"      , "Move the current waypoint(s) to the top of the waypoint list"}       ,
  {"move_waypoint_to_bottom"   , "Move the current waypoint(s) to the bottom of the waypoint list"}    ,
  {"exit_waypoint_window"      , "Exit the waypoint window"}                                           ,
  {"increase_context"          , "Increase the context (the number of lines shown around each waypoint)"}            ,
  {"decrease_context"          , "Decrease the context (the number of lines shown around each waypoint)"}            ,
  {"increase_before_context"   , "Increase the before context (the number of lines shown before each waypoint)"}            ,
  {"decrease_before_context"   , "Decrease the before context (the number of lines shown before each waypoint)"}            ,
  {"increase_after_context"    , "Increase the after context (the number of lines shown after each waypoint)"}             ,
  {"decrease_after_context"    , "Decrease the after context (the number of lines shown after each waypoint)"}             ,
  {"reset_context"             , "Set the context, before context, and after context to zero"},
  {"edit_waypoint_name"        , "Edit the name of the current waypoint"}                              ,
  {"clear_waypoint_name"       , "Clear the name of the current waypoint"}                              ,
  {"set_quickfix_list"         , "Set the quickfix list to locations of all waypoints"}                ,
  ...
  {"toggle_name"               , "Toggle whether the name appears"}                                    ,
