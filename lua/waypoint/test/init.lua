...
local _ = require'waypoint.test.tests.dirchanged'
local _ = require'waypoint.test.tests.filter'
local _ = require'waypoint.test.tests.filter_unhappy'
local _ = require'waypoint.test.tests.help'
local _ = require'waypoint.test.tests.highlight_treesitter'
local _ = require'waypoint.test.tests.highlight_vanilla'
...
local _ = require'waypoint.test.tests.move_to_waypoint'
...
local _ = require'waypoint.test.tests.undo_with_errors'
